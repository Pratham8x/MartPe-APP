...
import { getDomainPageData } from "../../../../gql/api/domainPage";
...
function Food() {
  ...
  useEffect(() => {
    async function domainDataFetch() {
      const response = await getDomainPageData(payload);
      const { getDomainPageData: data } = response || {};
